...
Bumro is a Live streaming open source platform for ecommerce Auctions. While sellers bring exotic collectibles on the app, buyers can place bids and be part of seamless global trades!
...
```bash
  git clone https://github.com/Shubhamxshah/Bumro-Auctions.git
```
Open Project
```bash
cd twitch-clone
